...
router.get('/books', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, category, page, limit, query, books, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.query, category = _a.category, page = _a.page, limit = _a.limit;
                query = {};
                if (category) {
                    query.category = category;
                }
                return [4 /*yield*/, models_1.Book.find(query)
...
router.post('/books', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                newBook = new models_1.Book(req.body);
...
router.put('/books/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var updatedBook, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, models_1.Book.findByIdAndUpdate(req.params.id, req.body, { new: true })];
            case 1:
                updatedBook = _a.sent();
                if (!updatedBook) {
...
router.delete('/books/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, models_1.Book.findByIdAndUpdate(req.params.id, { isDeleted: true }, { new: true })];
            case 1:
                deletedBook = _a.sent();
                if (!deletedBook) {
                    return [2 /*return*/, res.status(404).json({ message: 'Book not found' })];
